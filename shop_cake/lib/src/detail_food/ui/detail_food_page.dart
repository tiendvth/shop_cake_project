              ...
              builder: (context, state) {
                if (state is DetailFoodSuccess) {
                  if (state.data['data']['discount'] != null){
                    ...
                    price = DiscountCake.discountCake(state.data['data']['discount'],
                        state.data['data']['price']);
                  }else{
                    price = DiscountCake.discountCake(0.0,
                        state.data['data']['price']);
                  }
                  return Stack(
                    children: [
                                ...
                                children: [
                                  ClipRRect(
                                    child: Image.network(
                                      ...
                                      ReadFile.readFile(state.data['data']['image']),
                                      fit: BoxFit.fill,
                                ...
                                children: [
                                  ...
                                  Text(
                                    FormatPrice.formatVND(
                                        DiscountCake.discountCake(priceDiscount, state.data['data']['price'])),
                                    style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w500,
                                      color: kMainRedColor,
                            ...
                            child: Align(
                              ...
                              child: Padding(
                                ...
                                child: MaterialButton(
                                  ...
                                  color: kFFA6BD,
                                  onPressed: () async{
                                   await detailFoodCubit.addFoodToOrder(context, id, price);
                                    print(price);
